...
heroText: Hung's blog
tagline: FullStack Developer, DevOps, Hackintosh
# actionText: 立刻进入 →
# actionLink: /web/
...
features: # 可选的
  - title: Backend
    details: Java, Spring Framework, Database, ...
    link: /java/ # 可选
    imgUrl: /img/web.png # 可选
  - title: FrontEnd
    details: Vue, React, TypeScript, ...
    link: /frontend/
    imgUrl: /img/ui.png
  - title: DevOps
    details: Docker, Kubernate, ...
    link: /devops/
    imgUrl: /img/other.png
  - title: Algorithm & DS
    details: Algorithm, Data Structure, Competitive Programming, ... 
    link: /tech/
    imgUrl: /img/more.png
  - title: Developer Tools
    ...
    imgUrl: /img/more.png
  - title: Other
    details: Hackintosh, OS, Useful Softwares, ...
    link: /tech/
    imgUrl: /img/other.png
